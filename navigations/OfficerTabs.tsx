...
const OfficerTabs = () => {
  ...
  const navigationOptions = [
    { label: 'Register DSC', screenName: 'RegisterDSC' },
    { label: 'Unregister DSC', screenName: 'UnregisterDSC' },
  ];
          ...
          options={{
            tabBarButton: (props) => {
              ...
              return (
                ...
                >
                  <View style={{ justifyContent: 'center', alignItems: 'center', height: '100%',gap:5 }}>
                    {/* Use the determined color */}
                    <Ionicons name="information-circle-outline" color={iconColor} size={25} />
                    <Text style={{ color: textColor,fontSize:10 }}>DSC</Text>
                  </View>
                </TouchableOpacity>
              );
            },
